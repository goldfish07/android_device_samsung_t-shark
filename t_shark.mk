...
$(call inherit-product-if-exists, vendor/samsung/t_shark/t_shark-vendor.mk)

DEVICE_PATH := device/samsung/t_shark

DEVICE_PACKAGE_OVERLAYS += device/samsung/t_shark/overlay
